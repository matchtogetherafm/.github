...
> 축구를 사랑하는 모든 분들을 위한 축구의 선순환 플랫폼 — 소셜매치 · 용품 쇼핑 · 커뮤니티
...
회원가입 후 간단한 설문을 통해 선수 티어를 부여받고, 포지션을 선택하여 경기에 참가할 수 있습니다. 경기 외에도 AFM 자체 축구 용품을 구매하고, 커뮤니티에서 경기 후기와 용품 리뷰를 공유할 수 있습니다.

## 3. 프로젝트 목표

- 누구나 쉽게 11vs11 축구 경기를 찾고 참가할 수 있는 매칭 시스템 구축
- 설문 기반 티어 시스템으로 실력에 맞는 균형 잡힌 팀 구성
- 축구 경기부터 용품 구매, 커뮤니티까지 하나의 플랫폼에서 해결하는 축구의 선순환 구조 구축
